...
public final class GraphView extends JPanel {
    ...
    private final static Color lineColor = new Color(0, 200, 0, 180);
    ...
    public void addValues(Collection<Double> newValues) {
    ...
    protected void paintComponent(Graphics graphics) {
        ...
        //Title not working yet
         /* JLabel title = new JLabel("Stock Metric Over Time");
